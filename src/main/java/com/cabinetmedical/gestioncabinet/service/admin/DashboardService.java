...
import com.cabinetmedical.gestioncabinet.repository.admin.DashboardRepository;
...
public class DashboardService {
    ...
    public DashboardDTO getDashboardStatsDTO() {
        ...
        dto.setTotalCabinets(dashboardRepository.countCabinets());
        dto.setActiveUsers(dashboardRepository.countActiveUsers());
        dto.setPendingAdminFactures(dashboardRepository.countPendingAdminFactures());
        double totalRevenue = dashboardRepository.totalRevenue();
        ...
        List<AdminFacture> factures = dashboardRepository.findAdminFacturesBetween(startOfYear, endOfYear);
        ...
        dashboardRepository.findLastAdminFactures(PageRequest.of(0, 5))
        ...
        dashboardRepository.findLastCabinets(PageRequest.of(0, 5))
