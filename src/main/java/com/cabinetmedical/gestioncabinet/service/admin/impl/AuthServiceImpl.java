...
package com.cabinetmedical.gestioncabinet.service.admin.impl;
...
import com.cabinetmedical.gestioncabinet.service.admin.AuthService;
import com.cabinetmedical.gestioncabinet.service.admin.LoginAttemptService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        if (utilisateur.getCabinet() != null) {
            ...
            if (!utilisateur.getCabinet().getActif()) { // ou .getActif() selon votre getter
     ...
     //   }
        if (!passwordEncoder.matches(request.getPassword(), utilisateur.getPwd())) {
            loginAttemptService.loginFailed(request.getLogin());
            throw new RuntimeException("Mot de passe incorrect");
        }
