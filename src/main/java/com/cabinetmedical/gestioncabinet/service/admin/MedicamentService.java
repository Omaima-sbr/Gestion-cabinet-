...
import com.cabinetmedical.gestioncabinet.repository.admin.MedicamentRepository;
...
public class MedicamentService {
    ...
    public List<Medicament> rechercherMedicaments(String search) {
        ...
        return medicamentRepository.searchMedicaments(search);
    }

    // Autocomplétion pour le médecin
    public List<Medicament> autocompletion(String nom) {
        return medicamentRepository.findByNomContainingIgnoreCaseAndActifTrue(nom);
    }
